...
\title{\mc 脳波を用いた運動想起{\rm Brain Computer Interface}のためのEnd to End学習}
...
\chapter{{\mc 運動想起型{\rm BCI}の従来手法}}
\input{chapter/chapter3/FEATURE}
\input{chapter/chapter3/CSP}
\input{chapter/chapter3/sotuken}

\chapter{\mc End to Endに向けた提案手法}
\label{chapter:myop}
\input{chapter/chapter4/NN}
